...
9) [<a href="http://kanji.koohii.com/profile/kapalama">kapalama</a>] 15-11-2010(3): 処方箋 =処方せん=処方䇳, 付箋 =附箋, 用箋 , 便箋 , 鄭箋 <a href="../2991">stationary</a> (#2991 箋) セン( 浅 ) ... Parts: 竹 , 戔 (old 㦮) ... Story: <em>Pandas</em> make their <strong>Stationery</strong> out of <em>Old Parade floats</em>. They eat the living stuff, so they have to source the <strong>Stationery</strong> from old stuff.
