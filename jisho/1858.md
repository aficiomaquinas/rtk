...
8) [<a href="http://kanji.koohii.com/profile/eri401">eri401</a>] 25-6-2011(3): <strong>Parcel post</strong> is ridiculously bad. <em>Dragging</em> my package down the <em>road</em> will never be equal to (<em>=/=</em>) wrapping it carefully in a <em>towel</em> padding that comes with express delivery.   <a href="http://jisho.org/kanji/details/逓信">逓信</a>   【ていしん】 (n) communications (e.g. post, tele.);. 
