...
As a primitive this character can take two meanings. In the form given here it will mean a very small dog (which we shall refer to as a chihuahua for convenience sake). When it takes the form t to the left of a character, we shall give it the meaning of a pack of wild dogs.
