...
10) [<a href="http://kanji.koohii.com/profile/diracbracket">diracbracket</a>] 17-1-2010(3): Sakasama no hi (  <a href="http://jisho.org/kanji/details/逆様の日">逆様の日</a>  ), or &quot;Inversion Day&quot;, is the Japanese national holiday on which everything is<strong> inverted</strong>, so you will see <em>mountain goats</em> that have been brought down to graze on the <em>roads</em> while the salarymen try to commute in their cars across the mountains. 
