...
8) [<a href="http://kanji.koohii.com/profile/eri401">eri401</a>] 20-5-2011(4): I wanted neat, orderly<strong> tile</strong>s that all   <a href="http://jisho.org/kanji/details/互">互</a>  <a href="../757">mutually</a> <span class="index">(#757 <a href="http://jisho.org/kanji/details/互">互</a>)</span> resembled each other. However, the little<strong> tile</strong>s I got are uneven and asymmetrical with a big crack in the middle!   <a href="http://jisho.org/kanji/details/瓦落多">瓦落多</a>  =がらくた= junk; rubbish; trash; garbage; odds and ends. 
