...
2) [<a href="http://kanji.koohii.com/profile/chrislewisca">chrislewisca</a>] 21-3-2007(61): After you <a href="../650">beckon</a> (#650 招) someone by seducing them, you<strong> kidnap</strong> them and hang them upside down (the reversed positions of <em>seduce</em>).
...
5) [<a href="http://kanji.koohii.com/profile/jonnay">jonnay</a>] 21-2-2008(13): <strong>Kidnap</strong>ping is related to, but opposite to <a href="../650">beckon</a> (#650 招). If you beckon someone, you ask them to come to you, rather then going to them (to steal them). The kanji is an illustration of that fact, because the <a href="../11">mouth</a> (#11 口) is above the <a href="../83">sword</a> (#83 刀).
...
7) [<a href="http://kanji.koohii.com/profile/hornlo">hornlo</a>] 1-6-2011(8): [ <strong>kidnap</strong> = <em>fingers</em> + <em>mouth</em> / <em>dagger</em> ] - to <strong>kidnap</strong> someone, use your <em>fingers</em> to cover their <em>mouth</em> while holding a <em>dagger</em> at their throat; note: mouth over dagger, opposite of <a href="../86">seduce</a> (#86 召); cf <a href="../650">beckon</a> (#650 招).

8) [<a href="http://kanji.koohii.com/profile/CountPacula">CountPacula</a>] 28-1-2011(4): Easiest way to keep this separate from <a href="../650">beckon</a> (#650 招) is to note that in this case, the <em>blade</em> is -under- the mouth. In other words, the <em>fingers</em> here are holding a <em>blade</em> at someone&#039;s -throat-.
