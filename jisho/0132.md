...
9) [<a href="http://kanji.koohii.com/profile/calderra">calderra</a>] 15-9-2009(5): Care should be taken to distinguish this kanji from &quot;icicle&quot; (#131 <a href="http://jisho.org/kanji/details/氷">氷</a>). The only difference is that little ledge pushing the drop into a higher position. Right now I use a combined story- it takes an<strong> ETERNITY</strong> for that little DROP of WATER to fall down the ledge and make an ICICLE. 
