...
8) [<a href="http://kanji.koohii.com/profile/uberclimber">uberclimber</a>] 24-10-2010(11): Another word for<strong> double</strong> is clone. The <em>Jedi</em> all died under the <em>muzzle</em>s of <strong>clone</strong> trooper guns.   <a href="http://jisho.org/kanji/details/倍">倍</a>   (ばい) :<strong> double</strong>, two times. 
