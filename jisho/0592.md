...
<i>Sheep</i> . . . <i>water</i> . . . <i>yawn/lack</i>. Although this character looks rather simple, special care should be taken in learning it because of the proximity of the final two elements to the character for <i>next</i>, which we learned in frame 510. Note, too, that the <i>water</i> comes UNDER the <i>sheep</i>, rather than on its own to the left.
