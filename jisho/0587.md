...
8) [<a href="http://kanji.koohii.com/profile/sgrant">sgrant</a>] 18-10-2008(7): For the <em>ALIEN</em> fans. Imagine little Newt from the film, in that famous scene, covered with <em>dirt</em>, saying &quot;They mostly come at <em>nightbreak</em>, mostly&quot;. Now imagine her stepping up to the<strong> podium</strong> to collect an Oscar, for that truly chilling performance, alongside an <em>ALIEN</em> in a <em>top-hat</em> for the occasion. (I take <a href="../586">-times</a> <span class="index">(#586 <a href="http://jisho.org/kanji/details/回">回</a>)</span> to mean <em>ALIEN</em>). 
