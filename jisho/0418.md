...
2) [<a href="http://kanji.koohii.com/profile/kapalama">kapalama</a>] 5-11-2010(15): 鍵盤 <a href="../2761">key</a> (#2761 鍵) ケン, かぎ ... Parts: 金 , 建 (cf 建物 <a href="../391">build</a> (#391 建), 健康 <a href="../974">healthy</a> (#974 健)) ... Story: The most important <em>Metal</em> in any <em>build</em>ing is the <strong>lock</strong> on the front door, and without a <strong>key</strong> you ain&#039;t getting in. This kanji means both lock and<strong> key</strong> to most Japanese people. 錠前 is technically the word for lock but it&#039;s not used in daily conversation.
