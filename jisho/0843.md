...
4) [<a href="http://kanji.koohii.com/profile/Shibo">Shibo</a>] 18-5-2008(38): Out of two potential <em>husbands</em>, which would mom and dad<strong> approve</strong> of? Well, the one with <em>shells</em> (money) of course!!! (big thanks to zazen here but I keep getting this one confused with <a href="../1074">choose</a> <span class="index">(#1074 <a href="http://jisho.org/kanji/details/択">択</a>)</span> later.. So I figure mom and dad would be the ones whose approval we&#039;d like). 
...
8) [<a href="http://kanji.koohii.com/profile/Asgard">Asgard</a>] 3-9-2006(9): Before exchanging the <em>two husbands</em> on the reality TV show (see <a href="../842">exchange</a> <span class="index">(#842 <a href="http://jisho.org/kanji/details/替">替</a>)</span>) the two wives must <strong>approve</strong> first. One way of getting them to <strong>approve</strong> is to pay them lots of <em>shells</em>, which is what the TV station does. 
