...
9) [<a href="http://kanji.koohii.com/profile/Meconium">Meconium</a>] 17-5-2009(5): The symbiote is <strong>accumulating</strong> near Eddie Brock&#039;s body. When enough of it has <strong>accumulated</strong>, it jumps onto him and attacks the base of his <em>brain</em>, turning him into <em>Venom</em>. (Since <em>Venom</em> only refers to the thread primitive at the bottom of the kanji, this distinguishes it from the <em>Spider-Man</em> primitive in <a href="../1363">dainty</a> <span class="index">(#1363 <a href="http://jisho.org/kanji/details/細">細</a>)</span>.). 
