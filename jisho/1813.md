...
3) [<a href="http://kanji.koohii.com/profile/wrightak">wrightak</a>] 9-7-2006(31): This is commonly read as   <a href="http://jisho.org/kanji/details/触る">触る</a>   （さわる）, meaning to touch or feel something. An <em>insect</em>&#039;s version of <em>horns</em> are its antennae (see <a href="../1813">contact</a> <span class="index">(#1813 <a href="http://jisho.org/kanji/details/触">触</a>)</span>). They are it&#039;s prime source of<strong> contact</strong> with the world and it uses them to touch and feel its way around. 
