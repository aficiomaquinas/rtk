...
As a primitive, this kanji can be used to mean tree or wood. In those cases where the last two strokes are detached from the trunk (6), we shall change its meaning to pole, or wooden pole.
