...
8) [<a href="http://kanji.koohii.com/profile/Atomik">Atomik</a>] 7-2-2010(4): In the <em>United States</em>, <em>women</em> are often considered by their sexist <em>taskmasters</em> to be bad at<strong> number</strong>s. (This is the first character in   <a href="http://jisho.org/kanji/details/数独">数独</a>   &quot;sudoku&quot;). 
...
10) [<a href="http://kanji.koohii.com/profile/uberclimber">uberclimber</a>] 31-3-2011(3): When it comes to the home business accounts and<strong> number</strong>s - for example, keeping track of how much <em>rice</em> is used - <em>women</em> are absolute <em>taskmasters</em>.   <a href="http://jisho.org/kanji/details/数える">数える</a>   かぞえる count;   <a href="http://jisho.org/kanji/details/偶数">偶数</a>   ぐうすう even<strong> number</strong>;   <a href="http://jisho.org/kanji/details/数学">数学</a>   すうがく mathematics. 
