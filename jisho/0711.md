...
3) [<a href="http://kanji.koohii.com/profile/Danieru">Danieru</a>] 6-6-2008(50): Sitting on the<strong> BRANCH</strong> of a coniferous tree, getting sharp <em>needles</em> in my <em>crotch</em>. (Remember there is no tree radical in this kanji, whereas <a href="../713">bough</a> <span class="index">(#713 <a href="http://jisho.org/kanji/details/枝">枝</a>)</span> (  <a href="http://jisho.org/kanji/details/枝">枝</a>  ) does because a &quot;bough&quot; is a main part of the tree, whereas this kanji refers to a smaller<strong> branch</strong>. It can also be used to refer to the<strong> branch</strong> of a store (  <a href="http://jisho.org/kanji/details/支店">支店</a>  ) which also has nothing to do with a tree). 
...
5) [<a href="http://kanji.koohii.com/profile/MeisterLlama">MeisterLlama</a>] 29-11-2008(21): I would try to steer away from using tree imagery for this kanji:   <a href="http://jisho.org/kanji/details/支">支</a>   (branch) is not actually used for tree<strong> branch</strong>es, but rather for conceptual<strong> branch</strong>es, like a store<strong> branch</strong> (  <a href="http://jisho.org/kanji/details/支店">支店</a>  ).   <a href="http://jisho.org/kanji/details/枝">枝</a>   (bough), on the other hand, is an actual <em>branch</em> from a <em>tree</em>. 
