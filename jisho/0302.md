...
6) [<a href="http://kanji.koohii.com/profile/DrJones">DrJones</a>] 18-1-2008(4): I recommend to learn this kanji along with <a href="../v4/1129">near</a> (#1129 近). The<strong> environs</strong> are all those things in the <em>path</em> that are at close distance, so you can reach them with the point of your <em>sword</em>. (environs = vicinity).
