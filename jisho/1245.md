...
6) [<a href="http://kanji.koohii.com/profile/peacemik">peacemik</a>] 26-6-2009(15): The <em>snare</em> in which the bird decayed (see <a href="../1243">decay</a> <span class="index">(#1243 <a href="http://jisho.org/kanji/details/朽">朽</a>)</span>) is<strong> dirty</strong>. You wash the<strong> dirty</strong> <em>snare</em> in <em>water</em>. The extra line represents the water level as you submerge the snare. (Thanks, rtkrtk.)   <a href="http://jisho.org/kanji/details/汚れ">汚れ</a>   (よごれ): dirt, stain, smudge   <a href="http://jisho.org/kanji/details/汚い">汚い</a>   (きたない):<strong> dirty</strong>, filthy, vile   <a href="http://jisho.org/kanji/details/汚染">汚染</a>   (おせん): pollution, contamination. 
