...
10) [<a href="http://kanji.koohii.com/profile/blannk">blannk</a>] 11-3-2010(5): <em>Craft</em> of grouping sentences together on a <em>page</em>. To disambiguate from another <em>page / head</em> Kanji with which I repeatedly confused this, 題 <a href="../389">topic</a> (#389 題), I now recall that I must use my <em>carpenter&#039;s square</em> to ensure that the left margin of the<strong> paragraph</strong> is straight.
