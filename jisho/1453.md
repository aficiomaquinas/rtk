...
3) [<a href="http://kanji.koohii.com/profile/snallygaster">snallygaster</a>] 20-3-2008(35): While the slave-buyer is perusing (<a href="../855">perusal</a> <span class="index">(#855 <a href="http://jisho.org/kanji/details/覧">覧</a>)</span>) the stack of <strong>slaves reclining on the floor</strong>, the slaves&#039;<strong> oversee</strong>r supplies them with <strong>dishes</strong> of gruel -- don&#039;t want the slaves starving to death before they can be sold! 
