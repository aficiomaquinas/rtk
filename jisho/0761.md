...
8) [<a href="http://kanji.koohii.com/profile/brainrobert1">brainrobert1</a>] 24-12-2010(5): Infant + human legs =<strong> allot</strong>. God<strong> allot</strong>ted each INFANT two (HUMAN) LEGS, unlike the beasts in the field who were<strong> allot</strong>ted four (animal) legs.   <a href="http://jisho.org/kanji/details/充てる">充てる</a>  ateru allocate(cf ateru to hit   <a href="http://jisho.org/kanji/details/当てる">当てる</a>  ）. 
