...
2) [<a href="http://kanji.koohii.com/profile/ihatobu">ihatobu</a>] 20-10-2008(105): Compare with <a href="../270">pig-iron</a> (#270 銑). In moving from <strong>pig-iron</strong> to<strong> iron</strong>, some of the <em>metal&#039;s</em> maleability is <em>LOST</em>. (The only difference between the two kanji is that<strong> IRON</strong> has knee-less, unbending legs, while PIG-IRON (270) has very supple, bendable legs.).
...
7) [<a href="http://kanji.koohii.com/profile/Hinode">Hinode</a>] 29-1-2009(12): <strong>Iron</strong>, compared to <a href="../270">pig-iron</a> (#270 銑), has <em>lost</em> most of its carbon in the refining process. This makes it less brittle and a lot easier to use.
