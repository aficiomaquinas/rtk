...
4) [<a href="http://kanji.koohii.com/profile/romanrozhok">romanrozhok</a>] 16-2-2008(17):   <a href="http://jisho.org/kanji/details/排他">排他</a>   【はいた】 (n) exclusion; (P)   <a href="http://jisho.org/kanji/details/排日">排日</a>   【はいにち】 (n) anti-Japanese; (P)  <a href="http://jisho.org/kanji/details/排出">排出</a>   【はいしゅつ】 (n,vs) evacuation; emission (e.g. of CO2, etc.); ejection; (P)   <a href="http://jisho.org/kanji/details/排除">排除</a>   【はいじょ】 (n,vs) exclusion; removal; rejection; (P) STORY: Giving everyone the FINGER in a JAIL CELL is a good way to be EXCLUDED by everyone from the next prison break. 
