...
2) [<a href="http://kanji.koohii.com/profile/rtkrtk">rtkrtk</a>] 14-1-2008(75): To avoid confusing with <a href="../677">contraption</a> (#677 械), focus on the &quot;ism&quot; of<strong> mechanism</strong>. For example, fetishism refers to having a fetish;<strong> mechanism</strong> here refers to having a mecha-like property, where mecha is a type of anime robot that can transform itself. Imagine a mecha that can transform itself between two forms: a huge immovable <em>tree</em> (as a form of defense) and a gigantic marching <em>abacus</em> that smashes enemies between its giant beads.
