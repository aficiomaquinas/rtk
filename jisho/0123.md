...
7) [<a href="http://kanji.koohii.com/profile/ebat79">ebat79</a>] 6-8-2010(3): <strong>Squisito</strong>, <strong>Raffinato</strong> : Pensare ad una donna che può essere definita squisita, si intende dire che è una donna speciale e che sono in poche a poterlo essere e solitamente le persone così squisite le si incontra per poco tempo. <strong>Composizione</strong> : Donna <a href="../98">woman</a> <span class="index">(#98 <a href="http://jisho.org/kanji/details/女">女</a>)</span> + Poco <a href="../106">few</a> <span class="index">(#106 <a href="http://jisho.org/kanji/details/少">少</a>)</span>. <strong>On</strong> : ミョウ <strong>Kun</strong> : ビョウ、 たえ. 
