...
10) [<a href="http://kanji.koohii.com/profile/eri401">eri401</a>] 31-5-2011(5): This kanji means an<strong> overall</strong> link that shows key relationships - especially in the sense of who rules/governs. <em>Spiderman</em> is <em>allotted</em> control<strong> overall</strong> the villain who wear<strong> overall</strong>s.   <a href="http://jisho.org/kanji/details/系統">系統</a>   = けいとう = lineage; ancestry......   <a href="http://jisho.org/kanji/details/伝統">伝統</a>   = でんとう = tradition   <a href="http://jisho.org/kanji/details/統合">統合</a>   =とうごう =(1) unification (2) built-in. 
