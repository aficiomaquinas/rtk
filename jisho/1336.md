...
3) [<a href="http://kanji.koohii.com/profile/Django">Django</a>] 18-9-2007(23): <em>Spiderman</em> spends the night at a traditional Japanese <a href="../995">inn</a> <span class="index">(#995 <a href="http://jisho.org/kanji/details/宿">宿</a>)</span>, to spend time with his friend <em>Mr T</em> snorting <em>cocaine under the ceiling</em>. Alas, that&#039;s not <em>cocaine</em>, it&#039;s one of those magic mushrooms from Alice in Wonderland. <em>Spiderman</em> and <em>Mr T</em> start to<strong> shrink</strong>. 
