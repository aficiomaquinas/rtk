...
4) [<a href="http://kanji.koohii.com/profile/kapalama">kapalama</a>] 11-3-2011(2): 嚇々たる =赫々たる, 嚇怒する =赫怒する <a href="../v4/2908">incandescent</a> (#2908 赫) カク( 嚇 ) ... Parts: 赤 , 赤 (cf. 嚇す <a href="../v4/2026">menacing/upbraid</a> (#2026 嚇)) ... Note: means, reads the same as 嚇 <a href="../v4/2026">menacing/upbraid</a> (#2026 嚇) ... Story: <em>Double Red</em> filaments in a <strong>Incandescent</strong> bulb, as opposed to RED lighting (get it?).
