...
2) [<a href="http://kanji.koohii.com/profile/mcfate">mcfate</a>] 14-2-2008(24): If the borders of a <em>state</em> are all <em>water</em>, then it is more properly called a &#039;<strong>continent</strong>&#039; instead. (For 州 <a href="../v4/128">state</a> (#128 州), I think of the small-dash/big-dash alternating pattern that is used for state borders on some maps.).
...
4) [<a href="http://kanji.koohii.com/profile/kapalama">kapalama</a>] 18-8-2011(6): 八重洲線 , 六大洲 =六大州, 座洲 =座州=坐洲, 中洲 =中州, 砂洲 =砂州, 满洲国 =滿洲國=満州国=Manchukuo, 滿洲 =满洲=Manchuria, <a href="../v4/2289">continent</a> (#2289 洲) シュウ( 州 ), す( 州 ) ... Parts:氵, 州 <a href="../v4/128">state</a> (#128 州) ... Story: Ignore the keyword; this is just an alternate writing of 州 <a href="../v4/128">state</a> (#128 州). More correctly, all of the former uses of this kanji (other than names) have been collapsed into the simplified character 州 .
