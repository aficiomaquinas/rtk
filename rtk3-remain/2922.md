...
3) [<a href="http://kanji.koohii.com/profile/kapalama">kapalama</a>] 14-11-2010(4): 疎通 , 中疏 , 疏水 <a href="../v4/2922">transcription</a> (#2922 疏) ソ(cf 流 ) ... Parts: ⺪/疋, Manneken Pis (Infant+Bottom River) (cf: 硫酸 <a href="../v4/763">sulphur</a> (#763 硫), 流行る <a href="../v4/764">current</a> (#764 流), 琉球王国 <a href="../v4/2557">lapis lazuli</a> (#2557 琉) ... Story:Travel books are just a <strong>transcription</strong> on how to get the <em>7 stops</em> from your hotel to the <em>Manneken Pis</em> (Or the <em>7 stops</em> from the boy(<em>Manneken Pis</em>) to the girl (<em>Jeanneke Pis</em>).
