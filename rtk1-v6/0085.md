...
6) [<a href="http://kanji.koohii.com/profile/kanjihito">kanjihito</a>] 22-4-2012(26): Collecting<strong> tribute</strong>s is the <em>craft</em> of collecting <em>clams ($)</em> (note that craft is on top of the clam, as a tax ON money) (Also note that a <a href="../v4/81">tribute</a> (#81 貢) is generally given to show esteem or gratitude, a <a href="../v4/378">levy</a> (#378 賦) is a charge, a <a href="../v4/884">duty</a> (#884 役) is an obligation and not not just an import <a href="../v4/1778">tariff</a> (#1778 租), and a real <a href="../v4/895">tax</a> (#895 税) is the work of the <em>devil</em> (the right primitive of the kanji).
