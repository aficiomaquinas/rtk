...
1) [<a href="http://kanji.koohii.com/profile/mspertus">mspertus</a>] 26-12-2006(142): <em>Long ago</em> our ancestors <strong>set aside</strong> the use of fingers and began to use cutlery. (Raichu,11-7-2006) The way I remember it&#039;s 昔 <a href="../v4/1184.html">once upon a time</a> (#1184 昔) rather than 旧 <a href="../v4/35.html">olden times</a> (#35 旧) is that they began to use cutlery to eat <em>salad</em>. (I also think about how when you visit the Medieval Times theme park, which is set in <em>Once upon a time</em>, their gimmick is that you eat with your fingers.).
